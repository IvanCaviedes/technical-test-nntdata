...
import { NttDataMockApiReplyCallback } from './mock-api.types';
import { Observable, of, take, throwError } from 'rxjs';

export class NttDataMockApiHandler {
  request!: HttpRequest<any>;
  urlParams!: { [key: string]: string };

  private _reply: NttDataMockApiReplyCallback = undefined;
  ...
  reply(callback: NttDataMockApiReplyCallback): void {
